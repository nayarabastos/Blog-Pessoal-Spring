...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/nayarabastos/Blog-Pessoal-Spring) dentro da pasta do *Workspace* do STS

```bash
git clone https://github.com/nayarabastos/Blog-Pessoal-Spring.git
```
...
Desenvolvido por [**Nayara**](https://github.com/nayarabastos)
